...
export default {
    ...
    data(){
        return{
            ...
            chinese:[{title:"ラーメン",cal:"443"},{title:"塩ラーメン",cal:"401"},{title:"味噌ラーメン",cal:"477"},{title:"五目ラーメン",cal:"665"},{title:"チャーシュー麺",cal:"507"},{title:"冷やし中華",cal:"467"},{title:"冷麺",cal:"404"},{title:"あんかけかた焼きそば",cal:"918"},{title:"あんかけ焼きそば",cal:"517"},{title:"焼きビーフン",cal:"627"},{title:"麻婆豆腐",cal:"413"},{title:"青椒肉絲",cal:"487"},{title:"八宝菜",cal:"393"},{title:"回鍋肉",cal:"557"},{title:"エビチリ",cal:"408"},{title:"麻婆茄子",cal:"450"},{title:"チャーハン",cal:"754"},{title:"五目チャーハン",cal:"703"},{title:"ビビンバ",cal:"550"},{title:"クッパ",cal:"381"},{title:"かに玉",cal:"218"},{title:"酢豚",cal:"467"},{title:"みそ炒め",cal:"250"},{title:"レバニラ炒め",cal:"220"},{title:"ギョーザ",cal:"423"},{title:"シューマイ",cal:"282"},{title:"小籠包",cal:"274"},{title:"春巻き",cal:"369"},{title:"ちまき",cal:"310"},{title:"にら饅頭",cal:"259"},{title:"バンバンジー",cal:"230"},{title:"肉まん",cal:"201"},{title:"その他"}],
